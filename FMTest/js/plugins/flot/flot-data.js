...
$(function () {
    ...
    var jqxhr = $.get("http://localhost/FMTest/api/Customer", function (data) {
        customers = data;
        var group1 = customers.filter(function (customer) { return customer.Age > 0 && customer.Age <= 25; }).length;
        var group2  = customers.filter(function (customer) { return customer.Age > 25 && customer.Age <= 50; }).length;
        var group3 = customers.filter(function (customer) { return customer.Age > 50 && customer.Age <= 75; }).length;
        var group4 = customers.filter(function (customer) { return customer.Age > 75 && customer.Age <= 100; }).length;
        var group5 = customers.filter(function (customer) { return customer.Age > 100; }).length;
